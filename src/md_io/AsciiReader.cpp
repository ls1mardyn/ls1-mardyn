...
void md_io::AsciiReader::readPhaseSpaceHeader(Domain* domain) {
...
void md_io::AsciiReader::readPhaseSpace(datastructures::ParticleContainer<Molecule>* particleContainer, Domain* domain) {
