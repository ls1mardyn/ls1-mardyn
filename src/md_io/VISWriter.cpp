...
md_io::VISWriter::VISWriter(unsigned long writeFrequency, string filename, unsigned long numberOfTimesteps, bool incremental) {
   _filename = filename;
...
md_io::VISWriter::~VISWriter(){}

void md_io::VISWriter::initOutput(datastructures::ParticleContainer<Molecule>* particleContainer,
                         parallel::DomainDecompBase* domainDecomp, Domain* domain) {
}

void md_io::VISWriter::doOutput(datastructures::ParticleContainer<Molecule>* particleContainer,
...
void md_io::VISWriter::finishOutput(datastructures::ParticleContainer<Molecule>* particleContainer,
                         parallel::DomainDecompBase* domainDecomp, Domain* domain){
}
