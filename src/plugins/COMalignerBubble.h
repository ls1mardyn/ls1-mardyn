...
#ifndef MARDYN_TRUNK_COMALIGNERB_H
#define MARDYN_TRUNK_COMALIGNERB_H
...
* \endcode
*/
class COMalignerBubble : public PluginBase{
...
public:
    ...
    std::string getPluginName()override {return std::string("COMalignerBubble");}

    static PluginBase* createInstance(){return new COMalignerBubble();}

};


#endif //MARDYN_TRUNK_COMalignerBubble_H
