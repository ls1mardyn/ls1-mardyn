...
/**
 * Must be aware of the component types and choose how to process accordingly?
*/
class AdResSCellProcessor: public CellProcessor{

    private:
    CellProcessor* cell_processor;//For equal component interactions

    public:
    AdResSCellProcessor(const double cfRad, const double ljcRad);
