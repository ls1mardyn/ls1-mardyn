...
namespace Grid3D {
	...
	public:
		...
		bool ParticleInsideMeasuringSpace(std::array<double, 3> nodal_pos, std::array<double, 3> par_pos);
	...
	public:
		...
		int GetTotalElements(){ return this->total_elements; }
		ElementInfo& GetElementInfo(){ return this->element_information; }
		...
		NodeInformation& GetNodeInfo(){ return this->node_information; }
