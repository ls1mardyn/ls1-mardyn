 ...
 */
class AdResSGeneralDomainDecomposition : public DomainDecompMPIBase {
public:
	/**
	 ...
	 * @param forceGrid
	 */
    AdResSGeneralDomainDecomposition(double interactionLength, Domain* domain, bool forceGrid);

	// documentation see father class (DomainDecompBase.h)
	~AdResSGeneralDomainDecomposition() override;
