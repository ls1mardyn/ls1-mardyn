...
#include "parallel/NeighborAquirer.h"
...
void NeighbourCommunicationSchemeTest::testShiftIfNecessary() {
	...
	NeighborAquirer::shiftIfNeccessary(domainLength, &region, shift); // region is within domain box
	...
	NeighborAquirer::shiftIfNeccessary(domainLength, &region, shift);
...
void NeighbourCommunicationSchemeTest::testOverlap() { // assume this one works for now, because you thought about it long and hard.
	...
	NeighborAquirer::overlap(&region01, &region02);
...
void NeighbourCommunicationSchemeTest::testIOwnThis() { // i own a part of this
	...
	ASSERT_EQUAL(NeighborAquirer::isIncluded(&region01, &region02), true);
	...
	ASSERT_EQUAL(NeighborAquirer::isIncluded(&region01, &region02), false);
