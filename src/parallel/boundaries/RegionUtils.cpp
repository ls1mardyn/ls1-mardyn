...
RegionUtils::getInnerRegionSlab(const std::array<double, 3> &givenRegionBegin,
...
bool RegionUtils::isMoleculeLeaving(const Molecule &molecule,
...
std::tuple<std::array<double, 3>, std::array<double, 3>>
RegionUtils::getOuterRegionSlab(const std::array<double, 3> &givenRegionBegin,
                              const std::array<double, 3> &givenRegionEnd,
                              DimensionUtils::DimensionType dimension, 
