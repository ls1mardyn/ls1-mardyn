...
Accumulator* AbstrControlRegionT::CreateAccumulatorInstance() {
	if(_bDebugOutput) global_log->info() << "[SphericalTemperatureControl]: AbstrControlRegionT::CreateAccumulatorInstance has been called "<< endl;
	Accumulator* accumulator = new Accumulator(true, true, true);
	return accumulator;
}

void AbstrControlRegionT::readXML(XMLfileUnits& xmlconfig) {
	if(_bDebugOutput) global_log->info() << "[SphericalTemperatureControl]: AbstrControlRegionT::readXML has been called "<< endl;
...
void AbstrControlRegionT::VelocityScalingInit(XMLfileUnits& xmlconfig) {
	if(_bDebugOutput) global_log->info() << "[SphericalTemperatureControl]: AbstrControlRegionT::VelocityScalingInit has been called "<< endl;
	// settings
...
void AbstrControlRegionT::CalcGlobalValues(DomainDecompBase* domainDecomp) {
	if(_bDebugOutput) global_log->info() << "[SphericalTemperatureControl]: AbstrControlRegionT::CalcGlobalValues has been called "<< endl;
...
void AbstrControlRegionT::ResetLocalValues() {
	if(_bDebugOutput) global_log->info() << "[SphericalTemperatureControl]: AbstrControlRegionT::ResetLocalValues has been called "<< endl;
	// reset local values
...
void AbstrControlRegionT::InitBetaLogfile() {
	if(_bDebugOutput) global_log->info() << "[SphericalTemperatureControl]: AbstrControlRegionT::InitBetaLogfile has been called "<< endl;
	if (_localMethod == VelocityScaling) {
#ifdef ENABLE_MPI
...
void AbstrControlRegionT::WriteBetaLogfile(unsigned long simstep) {
	if(_bDebugOutput) global_log->info() << "[SphericalTemperatureControl]: AbstrControlRegionT::WriteBetaLogfile has been called "<< endl;
	if (_localMethod != VelocityScaling) {
		return;
	}
...
DistControl* AbstrControlRegionT::getDistControl() {
	if(_bDebugOutput) global_log->info() << "[SphericalTemperatureControl]: AbstrControlRegionT::getDistControl has been called "<< endl;
...
// 	if(_bDebugOutput) global_log->info() << "[SphericalTemperatureControl]: AbstrControlRegionT::update  has been called "<< endl;
// 	SphericalRegionObs::update(subject);
// }

void AbstrControlRegionT::InitAddedEkin() {
	if(_bDebugOutput) global_log->info() << "[SphericalTemperatureControl]: AbstrControlRegionT::InitAddedEkin has been called "<< endl;
	if (_localMethod == VelocityScaling) {
#ifdef ENABLE_MPI
		DomainDecompBase* domainDecomp = &(global_simulation->domainDecomposition());
		int rank = domainDecomp->getRank();
...
void AbstrControlRegionT::writeAddedEkin(DomainDecompBase* domainDecomp, const uint64_t& simstep) {
	if(_bDebugOutput) global_log->info() << "[SphericalTemperatureControl]: AbstrControlRegionT::writeAddedEkin has been called "<< endl;
	if (_localMethod != VelocityScaling) return;
...
void SphericalTemperatureControl::ControlTemperature(Molecule* mol, unsigned long simstep) {
	if(_bDebugOutput) global_log->info() << "[SphericalTemperatureControl]: SphericalTemperatureControl::ControlTemperature has been called "<< endl;
	if (simstep % _nControlFreq != 0) return;
	if (simstep <= this->GetStart() || simstep > this->GetStop()) return;
