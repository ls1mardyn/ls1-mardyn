...
private:
	 ...
	 * returns T * k_b
	 * */
	double measureTemp(const std::array<double, 3> &low, const std::array<double, 3> &high,
	 ...
	 * */
	std::array<double, 3> computeMeanVelocityStep(const std::array<double, 3> &low, const std::array<double, 3> &high,
												  ParticleContainer *particleContainer, BinData &binData);
};
