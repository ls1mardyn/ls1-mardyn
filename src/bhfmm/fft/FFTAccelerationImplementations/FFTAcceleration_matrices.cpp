...
FFTDataContainer_matrices* FFTAcceleration_matrices::getFFTData(FFTAccelerableExpansion & Expansion)
{
...
void FFTAcceleration_matrices::FFT_M2L(FFTAccelerableExpansion & Source, FFTAccelerableExpansion & Target, FFTDataContainer* TransferFunction)
{
  ...
  FFTDataContainer_matrices* Tf_FFTData = static_cast<FFTDataContainer_matrices*>(TransferFunction);
