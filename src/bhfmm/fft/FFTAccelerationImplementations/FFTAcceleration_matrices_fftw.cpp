...
void FFTAcceleration_matrices_fftw::FFT_initialize_Source(FFTAccelerableExpansion & Expansion, double radius) 
{
...
void FFTAcceleration_matrices_fftw::FFT_initialize_TransferFunction(FFTAccelerableExpansion & Expansion)
{
  FFTDataContainer_matrices* FFTData = getFFTData(Expansion);
  FFT_precision** & Re = FFTData->Re;
  FFT_precision** & Im = FFTData->Im;
...
void FFTAcceleration_matrices_fftw::FFT_finalize_Target(FFTAccelerableExpansion & Expansion, double radius)
{
  FFTDataContainer_matrices* FFTData = getFFTData(Expansion);
  FFT_precision** & Re = FFTData->Re;
  FFT_precision** & Im = FFTData->Im;
