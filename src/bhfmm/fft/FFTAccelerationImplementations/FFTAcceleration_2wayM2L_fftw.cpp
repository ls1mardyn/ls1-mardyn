...
void FFTAcceleration_2wayM2L_fftw::FFT_initialize_Source(FFTAccelerableExpansion & Expansion, double radius) 
{
...
void FFTAcceleration_2wayM2L_fftw::FFT_initialize_TransferFunction(FFTAccelerableExpansion & Expansion)
{
  FFTDataContainer_arrays* FFTData = getFFTData(Expansion);
  FFT_precision* Re = FFTData->Re;
  FFT_precision* Im = FFTData->Im;
...
void FFTAcceleration_2wayM2L_fftw::FFT_finalize_Target(FFTAccelerableExpansion & Expansion, double radius)
{
  FFTDataContainer_arrays* FFTData = getFFTData(Expansion);
  FFT_precision* Re = FFTData->Re;
  FFT_precision* Im = FFTData->Im;
