...
class FFTAcceleration_scalBlocks_v0 : public FFTAccelerationAPI {
  ...
  public:
    ...
    ~FFTAcceleration_scalBlocks_v0() {delete _optFFT_API; delete[] _blockSize;} 
  ...
  protected:
    FFTDataContainer_scalBlocks_v0* getFFTData(FFTAccelerableExpansion & Expansion);
    FFTDataContainer_scalBlocks_v0* getFFTData_scal(FFTAccelerableExpansion & Expansion);
