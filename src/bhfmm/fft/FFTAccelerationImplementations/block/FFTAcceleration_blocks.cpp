...
FFTDataContainer_blocks* FFTAcceleration_blocks::getFFTData(FFTAccelerableExpansion & Expansion)
{
...
void FFTAcceleration_blocks::FFT_M2L_template(FFTAccelerableExpansion & Source, FFTAccelerableExpansion & Target, FFTDataContainer* TransferFunction, int order) 
{
...
void FFTAcceleration_blocks::FFT_M2L_OrderReduction_vec(FFTAccelerableExpansion & Source, FFTAccelerableExpansion & Target, FFTDataContainer* TransferFunction, int order)
{
  return FFT_M2L_template<true, true>(Source, Target, TransferFunction, order);
}

template <bool Vect, bool OrderRed>
void FFTAcceleration_blocks::FFT_M2L_2way_template(FFTAccelerableExpansion & Source1, FFTAccelerableExpansion & Source2, 
      FFTAccelerableExpansion & Target1, FFTAccelerableExpansion & Target2, FFTDataContainer* TransferFunction, int order)
{
  ...
  FFTDataContainer_blocks* TFData = static_cast<FFTDataContainer_blocks*>(TransferFunction);
...
void FFTAcceleration_blocks::FFT_M2L_2way(FFTAccelerableExpansion & Source1, FFTAccelerableExpansion & Source2, 
...
void FFTAcceleration_blocks::FFT_M2L_2way_vec(FFTAccelerableExpansion & Source1, FFTAccelerableExpansion & Source2, 
      FFTAccelerableExpansion & Target1, FFTAccelerableExpansion & Target2, FFTDataContainer* TransferFunction)
{
  return FFT_M2L_2way_template<true, false>(Source1, Source2, Target1, Target2, TransferFunction, 0);
}
      
void FFTAcceleration_blocks::FFT_M2L_2way_ORed(FFTAccelerableExpansion & Source1, FFTAccelerableExpansion & Source2, 
      FFTAccelerableExpansion & Target1, FFTAccelerableExpansion & Target2, FFTDataContainer* TransferFunction, int order)
{
  return FFT_M2L_2way_template<false, true>(Source1, Source2, Target1, Target2, TransferFunction, order);
}

void FFTAcceleration_blocks::FFT_M2L_2way_ORed_vec(FFTAccelerableExpansion & Source1, FFTAccelerableExpansion & Source2, 
      FFTAccelerableExpansion & Target1, FFTAccelerableExpansion & Target2, FFTDataContainer* TransferFunction, int order)
{
