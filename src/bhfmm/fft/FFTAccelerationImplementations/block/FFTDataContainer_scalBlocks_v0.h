...
class FFTDataContainer_scalBlocks_v0 : public FFTDataContainer {
  ...
  public:
    FFTDataContainer_scalBlocks_v0(int nbBlocks, int nx, int ny, bool scal, int* blockSize) 
      : _nbBlocks(nbBlocks), _nx(nx), _ny(ny), _scal(scal), _blockSize(blockSize) {}
    ...
    FFTDataContainer* copyContainer() {
      FFTDataContainer_scalBlocks_v0* copy = new FFTDataContainer_scalBlocks_v0(_nbBlocks, _nx, _ny, _scal, _blockSize);
      if(_scal) {
