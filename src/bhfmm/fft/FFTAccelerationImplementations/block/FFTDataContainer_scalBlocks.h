...
class FFTDataContainer_scalBlocks : public FFTDataContainer {
  ...
  public:
    FFTDataContainer_scalBlocks(int nbBlocks, int nx, int ny, bool scal, int* blockSize) 
    ...
    FFTDataContainer* copyContainer() {
      FFTDataContainer_scalBlocks* copy = new FFTDataContainer_scalBlocks(_nbBlocks, _nx, _ny, _scal, _blockSize);
      if(_scal) {
