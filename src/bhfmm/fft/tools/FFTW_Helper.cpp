...
#else
fftw_complex*  FFTW_Helper::Source2FFT(FFTAccelerableExpansion & Expansion, double radius)
#endif
{
  int n,m,fm;
...
#else
fftw_complex*  FFTW_Helper::TransferFunction2FFT(FFTAccelerableExpansion & Expansion)
#endif
{
  int n,m,fm;
  FFT_precision minus_one_neg_m = 1.0;
...
void FFTW_Helper::FFT2Local(FFTAccelerableExpansion & Expansion, double radius)
{ 
  execute_FFT2L();
