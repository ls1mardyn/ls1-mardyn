...
RDFForceIntegrator::RDFForceIntegrator(ParticleContainer* moleculeContainer, double rc, std::vector<std::vector<double> >* globalADist,
		std::vector<std::vector<std::vector<double> > >* globalSiteADist) : _moleculeContainer(moleculeContainer), _rc(rc),
		_globalADist(globalADist), _globalSiteADist(globalSiteADist){
	initTraversal();
}
