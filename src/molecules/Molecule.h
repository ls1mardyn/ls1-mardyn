...
public:
	...
	~Molecule() {
		assert(m_sites_d); delete[] m_sites_d;
		assert(m_osites_e); delete[] m_osites_e;
		assert(m_sites_F); delete[] m_sites_F;
	}
	...
	void setFM(double Fx, double Fy, double Fz, double Mx, double My, double Mz) {
		m_F[0]=Fx; m_F[1]=Fy; m_F[2]=Fz;
		m_M[0]=Mx; m_M[1]=My; m_M[2]=My;
	}
