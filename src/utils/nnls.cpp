...
int h12_(integer *mode, integer *lpivot, integer *l1, const integer *m, doublereal *u, integer *iue, doublereal *up,
		 doublereal *c__, integer *ice, const integer *icv, integer *ncv);
...
/*     ------------------------------------------------------------------ */
/* Subroutine */ int nnls_(doublereal *a, const integer *mda, const integer *m, const integer *n, doublereal *b,
						   doublereal *x, doublereal *rnorm, doublereal *w, doublereal *zz, integer *index,
						   integer *mode) {
...
L60:
	...
	if (diff_(&d__2, &unorm) > 0.) {
		...
		i__1 = npp1 + 1;
		h12_(&c__2, &npp1, &i__1, m, &a[j * a_dim1 + 1], &c__1, &up, &zz[1], &c__1, &c__1, &c__1);
...
/*     ------------------------------------------------------------------ */
/* Subroutine */ int h12_(integer *mode, integer *lpivot, integer *l1, const integer *m, doublereal *u, integer *iue,
						  doublereal *up, doublereal *c__, integer *ice, const integer *icv, integer *ncv) {
	/* System generated locals */
