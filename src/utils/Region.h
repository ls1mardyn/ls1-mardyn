...
public:
	...
	void SetLowerCorner(double* dLC) {for (unsigned short d = 0u; d<3; d++) { _dLowerCorner.at(d) = *dLC; } }
	void SetUpperCorner(double* dUC) {for (unsigned short d = 0u; d<3; d++) { _dUpperCorner.at(d) = *dUC; } }
