...
do
	...
	for i in {0..3} ;
	do
		outputFileName=output-of-jobs/out-ls1-2-16-$iScheme-$i.txt
		mpiexec -n 2 ../$executableName $inputfilename --steps 101 --final-checkpoint=0 >$outputFileName
	done
done
