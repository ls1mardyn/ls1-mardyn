...
do
	...
	for i in {0..3} ;
	do
		outputFileName=output-of-jobs/out-ls1-8-4-$iScheme-$i.txt
		mpiexec -n 8 ../$executableName $inputfilename --steps 101 --final-checkpoint=0 >$outputFileName
	done
done
