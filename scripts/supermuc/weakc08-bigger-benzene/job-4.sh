...
#@ job_name = mardyn-weak-4-bigger-benzen
#@ class = test
...
#@ output = output-of-jobs/LLRUN.out.4.$(jobid)
#@ error =  output-of-jobs/LLRUN.err.4.$(jobid)
#@ node = 4
#@ island_count = 1,1
#@ total_tasks = 8
##@ hold = user
...
envfilename=output-of-jobs/LLRUN.env.4
testhpfilename=output-of-jobs/LLRUN.thp.4
