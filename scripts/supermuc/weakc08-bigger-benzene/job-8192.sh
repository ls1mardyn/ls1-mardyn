...
#@ job_name = mardyn-weak-8192-bigger-benzen
#@ class = special
...
#@ output = output-of-jobs/LLRUN.out.8192.$(jobid)
#@ error =  output-of-jobs/LLRUN.err.8192.$(jobid)
#@ node = 8192
#@ island_count = 16,16
#@ total_tasks = 16384
#@ hold = user
...
envfilename=output-of-jobs/LLRUN.env.8192
testhpfilename=output-of-jobs/LLRUN.thp.8192
