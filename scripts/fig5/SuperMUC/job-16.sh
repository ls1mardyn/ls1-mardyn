...
###@ group = vip
###@ set_frequency = 2.3
#@ initialdir=/home/hpc/pr48te/di56giq5/svn/WR_2017/SuperMUC-Phase1/omp-strong-2/mktcts/
#@ job_name = omp-strong-1-16-sp-35
#@ class = test
...
NumProcs=1
executableName=MarDyn_6167.SEQ_RELEASE_AVX
...
do
	...
	#do
		...
		schemes="c04 c08 slice"
		for iScheme in $schemes ;
		do
			echo "scheme: $iScheme"
			inputFileName=low-2-$iScheme.xml
			outputFileName="output-of-jobs-1-nodes/low-2-$NumProcs-$OMP_NUM_THREADS-$iSize-$iScheme-$iRepe.txt"
