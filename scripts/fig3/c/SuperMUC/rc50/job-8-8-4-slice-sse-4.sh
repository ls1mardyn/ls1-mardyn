...
#@ initialdir=/home/hpc/pr48te/di56giq5/svn/WR_2017/SuperMUC-Phase1/particleTest-final-8-nodes/rc50
#@ job_name = pTest-8-8-sp-50
#@ class = test
...
NumProcs=64
executableName=MarDyn_5713.PAR_RELEASE_SSE-gcc-7-ibmmpi-RMM-SINGLE
...
do
	...
	outputFileName="output-of-jobs-8-nodes/out-$NumProcs-$iSize-$iScheme-$iRepe-SSE.txt"
