...
#@ job_name = mardyn-weak-512-bigger-benzen
#@ class = general
...
#@ output = output-of-jobs/LLRUN.out.512.$(jobid)
#@ error =  output-of-jobs/LLRUN.err.512.$(jobid)
#@ node = 512
#@ island_count = 1,1
#@ total_tasks = 1024
##@ hold = user
...
envfilename=output-of-jobs/LLRUN.env.512
testhpfilename=output-of-jobs/LLRUN.thp.512
