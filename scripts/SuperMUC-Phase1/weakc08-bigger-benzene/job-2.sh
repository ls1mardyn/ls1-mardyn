...
#@ job_name = mardyn-weak-2-bigger-benzen
#@ class = test
...
#@ output = output-of-jobs/LLRUN.out.2.$(jobid)
#@ error =  output-of-jobs/LLRUN.err.2.$(jobid)
#@ node = 2
#@ island_count = 1,1
#@ total_tasks = 4
##@ hold = user
...
envfilename=output-of-jobs/LLRUN.env.2
testhpfilename=output-of-jobs/LLRUN.thp.2
