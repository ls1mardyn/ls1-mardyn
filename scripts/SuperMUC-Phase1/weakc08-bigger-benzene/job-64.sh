...
#@ job_name = mardyn-weak-64-bigger-benzen
#@ class = general
...
#@ output = output-of-jobs/LLRUN.out.64.$(jobid)
#@ error =  output-of-jobs/LLRUN.err.64.$(jobid)
#@ node = 64
#@ island_count = 1,1
#@ total_tasks = 128
##@ hold = user
...
envfilename=output-of-jobs/LLRUN.env.64
testhpfilename=output-of-jobs/LLRUN.thp.64
