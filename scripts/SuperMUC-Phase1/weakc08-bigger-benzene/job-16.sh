...
#@ job_name = mardyn-weak-16-bigger-benzen
#@ class = test
...
#@ output = output-of-jobs/LLRUN.out.16.$(jobid)
#@ error =  output-of-jobs/LLRUN.err.16.$(jobid)
#@ node = 16
#@ island_count = 1,1
#@ total_tasks = 32
##@ hold = user
...
envfilename=output-of-jobs/LLRUN.env.16
testhpfilename=output-of-jobs/LLRUN.thp.16
