...
#@ job_name = mardyn-weak-4096-bigger-benzen
#@ class = large
...
#@ output = output-of-jobs/LLRUN.out.4096.$(jobid)
#@ error =  output-of-jobs/LLRUN.err.4096.$(jobid)
#@ node = 4096
#@ island_count = 8,8
#@ total_tasks = 8192
##@ hold = user
...
envfilename=output-of-jobs/LLRUN.env.4096
testhpfilename=output-of-jobs/LLRUN.thp.4096
