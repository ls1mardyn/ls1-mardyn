...
#@ job_name = mardyn-weak-32-bigger-benzen
#@ class = test
...
#@ output = output-of-jobs/LLRUN.out.32.$(jobid)
#@ error =  output-of-jobs/LLRUN.err.32.$(jobid)
#@ node = 32
#@ island_count = 1,1
#@ total_tasks = 64
##@ hold = user
...
envfilename=output-of-jobs/LLRUN.env.32
testhpfilename=output-of-jobs/LLRUN.thp.32
