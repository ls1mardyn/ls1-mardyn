...
#@ job_name = mardyn-weak-2048-bigger-benzen
#@ class = large
...
#@ output = output-of-jobs/LLRUN.out.2048.$(jobid)
#@ error =  output-of-jobs/LLRUN.err.2048.$(jobid)
#@ node = 2048
#@ island_count = 4,4
#@ total_tasks = 4096
##@ hold = user
...
envfilename=output-of-jobs/LLRUN.env.2048
testhpfilename=output-of-jobs/LLRUN.thp.2048
