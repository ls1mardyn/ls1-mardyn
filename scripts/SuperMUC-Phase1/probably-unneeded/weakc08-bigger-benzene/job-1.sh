...
#@ job_name = mardyn-weak-1-bigger-benzen
#@ class = test
...
#@ output = output-of-jobs/LLRUN.out.1.$(jobid)
#@ error =  output-of-jobs/LLRUN.err.1.$(jobid)
#@ node = 1
#@ island_count = 1,1
#@ total_tasks = 2
##@ hold = user
...
envfilename=output-of-jobs/LLRUN.env.1
testhpfilename=output-of-jobs/LLRUN.thp.1
