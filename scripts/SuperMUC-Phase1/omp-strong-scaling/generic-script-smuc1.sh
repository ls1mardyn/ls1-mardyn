...
###@ group = vip
###@ set_frequency = 2.3
#@ initialdir=/home/hpc/pr48te/di56giq5/svn/WR_2017/SuperMUC-Phase1/omp-strong-scaling/
...
#do
	...
	#do
		...
		do
			...
			outputFileName="output-of-jobs-GENERIC_ARG_NODES-nodes/out-$NumProcs-$OMP_NUM_THREADS-$iSize-$iScheme-$iRepe.txt"
