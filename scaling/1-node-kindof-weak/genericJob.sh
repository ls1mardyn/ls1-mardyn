...
executable="EXARG"
aprun -n $npes -N $ppn -d $OMP_NUM_THREADS -cc depth -j $HYPERTHREADING ./$executable IFARG 5 --final-checkpoint=0
...
#aprun -n 48 -N 24 ./exec/MarDyn inp/simple-lj.cfg 10 --final-checkpoint=0
