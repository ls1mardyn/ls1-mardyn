...
\begin{sidewaysfigure}
\centering
\subfloat[warp block processor (dataset: \filename{lj\_80000})]{\includegraphics[width=0.5\textwidth]{plots/cell_density_tesla_wbdp.pdf}}
\subfloat[thread block processor (dataset: \filename{lj\_80000})]{\includegraphics[width=0.5\textwidth]{plots/cell_density_tesla_dp.pdf}}\\
