...
HEADERS  += generators/MS2RSTGenerator.h
...
HEADERS  += generators/common/MS2RestartReader.h

SOURCES  += generators/MDGenerator.cpp
SOURCES  += generators/MS2RSTGenerator.cpp
...
SOURCES  += generators/common/MS2RestartReader.cpp
